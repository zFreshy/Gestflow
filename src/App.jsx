...
const MOCK_DATA = [
  ...
  { id: '6', description: 'Carlos Thomas', amount: 1500.00, type: 'expense', paymentMethod: 'pix', date: '23/09/2025', timestamp: new Date(2025, 8, 23, 12, 30).getTime(), subtitle: '020.000.000-88', exam: 'Tomografia', healthPlan: 'Porto Seguro Saúde', status: 'Cancelado' },
