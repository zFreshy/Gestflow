...
import { LayoutDashboard, Calendar, Receipt, ChevronLeft, ChevronRight, ChevronDown, FileText, LogOut, X, Truck, Target, Store } from 'lucide-react';
...
const MENU_ITEMS = [
    ...
    { path: '/padaria', label: 'Padaria', icon: Store },
